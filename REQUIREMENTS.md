...
| I-1.5 | The remaining toolchain questions are answered before Terraform is written | **Not met — four questions open in [`docs/floci.md`](docs/floci.md). This is the gate on I-2.x** |
